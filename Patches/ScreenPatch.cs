    ...
    public static void SceneTitles_Start(Scene_Titles __instance)
    {
        ...
        else if (MetaFile.Data.FirstLaunch)
        {
            ...
            obj.transform.Find("Title").gameObject.GetComponent<Text>().text =
                "<color=#EF0000>IMPORTANT NOTICE</color>\nWhile HTCCL tries its best to keep modded save files stable and consistent between game updates and mod changes, you may still encounter issues. HTCCL automatically creates backups (up to 100 by default). However, it is recommended to manually create backups of your save file. The save file can be found in %USERPROFILE%/AppData/LocalLow/MDickie/Hard Time III. If you encounter any issues, please report them in the Hard Time III Modding Discord server.";
        }
