...
internal static class Secrets
{
    ...
    public static readonly string[] EasterEggs =
    {
        ...
        "Coming soon: Hard Time III, the Board Game. You can finally experience the thrill of wrestling on your tabletop without the need for a computer. It comes with a 500-page rulebook, 1000 miniatures, and a 20-sided die. Pre-order now and get a free Mat Dickie figure. Batteries not included. Contains small parts. Not suitable for children under 3 years.",
        "Despite Mat Dickie's code, this game is actually pretty good.",
        "Did you know that 75% of statistics are made up on the spot?",
        "Did you know that HTCCL is an anagram of \"CLEWC\"? I don't know what that means, but it sounds cool.",
        "Did you know that HTCCL is not an acronym but a word? It's pronounced \"weasel\".",
        "Did you know that HTCCL is secretly a recursive acronym? It stands for \"HTCCL Eliminates Code Complexity Lazily\".",
        "Dit is geen paasei.",
        ...
        "Hello, player. I'd like to play a game. You have been trapped in a room with a computer that has Hard Time III installed on it. The only way to escape is beat every single wrestler in the game in every single match type in every single arena. If you fail, you will be locked in the room forever. Good luck.",
        ...
        "Hey, you. You're finally awake. You were trying to play modded Hard Time III, right? Walked right into that Mat Dickie ambush, same as us, and that Jabroni over there.",
        ...
        "So I've pondered this question for a long time. Hard Time III... what does it mean? I mean it's a game, that's clear. You play as a wrestler, playing matches against different opponents... But what does it mean? It can't just be a game, it seems to plain for that. The developer, Mat Dickie, he's a smart guy. He's made a lot of games, and they all have a meaning. So what does Hard Time III mean? I think I've finally figured it out. Hard Time III is a metaphor for life. Think about it. You start out as a rookie, with no experience. You have to work your way up, fighting against other people, trying to make a name for yourself. \"Matches\" are just a metaphor for the struggles of life. You have to fight against your opponents, and you have to win. If you don't, you'll be stuck in the same place forever. \"Titles\" are a thinly veiled allusion to the achievements and accolades we seek in our lives. You work hard, win your matches, gain a reputation, and then you are rewarded with a title. But that title isn't just a sign of victory in the game, it's representative of success, a testimony to your perseverance and dedication, just like in real life. Each character you encounter in Hard Time III symbolizes the various people we meet throughout our journey. Friends, rivals, mentors - they all shape our path, just as the other wrestlers influence our gameplay and strategy. We form alliances, nurture friendships, deal with rivalry, even experience betrayal - all part of the human experience. The health bar is akin to our physical and mental resilience. Just as we need to take care of our health in life, the health bar in the game is a reminder to take care of our wrestler. If we don't maintain it, our performance in the ring - and consequently our progress - suffers. Furthermore, the various locations or arenas in Hard Time III could be seen as metaphors for the different stages of our life or various environments we find ourselves in. Just like the changing scenery and audience in each match, our personal and professional environments keep changing, presenting new challenges and opportunities. In the end, Hard Time III isn't just about winning or losing a wrestling match. It's about the journey, the struggles, the victories, the defeats, and the learning that comes with it. It reflects our life's pursuit - a journey of self-discovery, fighting our own battles, reaching milestones, and persisting in the face of adversity. Mat Dickie's Hard Time III thus emerges not just as a game, but as a reflection of the human experience. So there you have it. Hard Time III is a metaphor for life. Mat Dickie, you've done it again.",
        ...
        "HTCCL II: The Jabroni Strikes Back - Coming soon to a Steam Workshop near you.",
    ...
    public static string GetConditionalEasterEgg()
    {
        switch (MetaFile.Data.TimesLaunched)
        {
            ...
            case 1000000:
                return
                    "You started HTCCL one million times! That's it, I'm calling the police. You are a danger to society. Or perhaps you cheated by editing the meta file. Either way, you are a Jabroni.";
            case 1000000000:
                return
            ...
            case < 0:
                return
                    "You started HTCCL a negative number of times. That's not possible. How did you do that? Did you hack the game? Or did you just edit the meta file? Either way, you are a Jabroni.";
            case 0:
                return
                    "You started HTCCL zero times. That's not possible. How did you do that? Did you hack the game? Or did you just edit the meta file? Either way, you are a Jabroni.";
        }
        ...
        {
            return
                "IngoH just announced that HTCCL is in fact going to be deleted. Haha, April Fools! You got pranked, Jabroni!";
        }
